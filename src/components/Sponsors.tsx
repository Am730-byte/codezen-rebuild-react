      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
          ...
          <div className="text-center">
            ...
            <div className="bg-gray-900/50 backdrop-blur-sm border border-pink-500/20 rounded-lg p-8 hover:border-pink-500/40 transition-all duration-300">
              <div className="mb-6">
                <img 
              ...
              <h4 className="text-xl font-bold text-pink-400 mb-4 tracking-wider">
                GURU TEG BAHADUR 4TH CENTENARY<br />
                ENGINEERING COLLEGE
              </h4>
